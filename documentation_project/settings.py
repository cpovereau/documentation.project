"""
Django settings for documentation_project project. Modif.
...
SECRET_KEY = 'django-insecure-9vug7v0#7m$_y_r@g@q8$^_k^sy5fr2a(au!j6(#x=ewcsk%85'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Accès authentifié par défaut
    ],
