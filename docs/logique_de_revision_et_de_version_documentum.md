# Logique de révision et de version dans Documentum

Ce document formalise la **logique métier de révision et de versionning** du CCMS **Documentum**. Il sert de référence pour :
